...
import com.example.recyclerviewlesson.databinding.FragmentRacesBinding
import com.example.recyclerviewlesson.Unit

class RacesFragment : Fragment() {
    private var _bindingFrag: FragmentRacesBinding? = null
    ...
    override fun onCreateView(
        ...
        _bindingFrag = FragmentRacesBinding.inflate(inflater, container, false)
        bindingFrag.rcView.setBackgroundResource(R.drawable.background_races)
        init()
    ...
    private fun init() {
        ...
        bindingFrag.apply {
            ...
            for (n in imageIdList.indices) {
                ...
                bgId = when (subName) {
                    resources.getString(R.string.elf) -> R.drawable.background_elf
                    resources.getString(R.string.horde) -> R.drawable.background_horde
                    else -> R.drawable.background_undead
                }
                unit = Unit(imageIdList[n], unitName, bgId)
