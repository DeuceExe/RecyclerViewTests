...
import com.example.recyclerviewlesson.databinding.FragmentUndeadBinding

class UndeadFragment : Fragment() {
    private var _bindingFrag: FragmentUndeadBinding? = null
    ...
    override fun onCreateView(
        ...
        _bindingFrag = FragmentUndeadBinding.inflate(inflater, container, false)
        bindingFrag.rcView.setBackgroundResource(R.drawable.background_undead)
        init()
        ...
        bindingFrag.apply {
            ...
            for (n in imageIdList.indices) {
                ...
                if(subName == "undead") {
                    ...
                    unit = Unit(imageIdList[n], unitName, R.drawable.background_undead)
