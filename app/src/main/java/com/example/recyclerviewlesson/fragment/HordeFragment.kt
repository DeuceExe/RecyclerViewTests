...
import com.example.recyclerviewlesson.databinding.FragmentHordeBinding

class HordeFragment : Fragment() {
    private var _bindingFrag: FragmentHordeBinding? = null
    ...
    override fun onCreateView(
        ...
        _bindingFrag = FragmentHordeBinding.inflate(inflater, container, false)
        bindingFrag.rcView.setBackgroundResource(R.drawable.background_horde)
        init()
        ...
        bindingFrag.apply {
            ...
            for (n in imageIdList.indices) {
                ...
                if(subName == "horde") {
                    ...
                    unit = Unit(imageIdList[n], unitName, R.drawable.background_horde)
